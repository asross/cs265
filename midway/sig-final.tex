...
\begin{figure}[!htb]
\begin{center}
\includegraphics[width=0.5\textwidth]{basic-workloads.png}
\end{center}
\caption{Hey!}
\label{fig:simple-workloads}
\end{figure}
...
\begin{figure}[!htb]
\begin{center}
\includegraphics[width=0.5\textwidth]{discover-decay.png}
\end{center}
\caption{Ho!}
\label{fig:discover-decay}
\end{figure}
...
\begin{figure}[!htb]
\begin{center}
\includegraphics[width=0.5\textwidth]{periodic-decay.png}
\end{center}
\caption{Hiya!}
\label{fig:periodic-decay}
\end{figure}
